...
namespace CVStatistics.WPF.Commands
{
    /// <summary>
    ...
    public class DelegateCommand : ICommand
    {
        ...
        /// </summary>
        /// <param name="execute">Action to execute.</param>
        public DelegateCommand(Action execute) : this(o => execute())
        {
            if (execute == null)
                throw new ArgumentNullException(nameof(execute));
        }
        ...
        /// <param name="execute">Action to execute.</param>
        /// <param name="canExecute">Function to determine if can execute.</param>
        public DelegateCommand(Action execute, Func<bool>? canExecute) : this(o => execute())
        {
            if (execute == null)
                throw new ArgumentNullException(nameof(execute));
